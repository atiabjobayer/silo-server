...
func TestParseFilename(t *testing.T) {
	tests := []struct {
		...
		{
			name:       "series episode NxNN pattern",
			path:       "/tv/Power Rangers (1993)/Season 07/Power Rangers - 7x13 - Orion Returns.mkv",
			wantTitle:  "Power Rangers",
			wantYear:   1993,
			wantType:   "series",
			wantSeason: 7,
			wantEp:     13,
		...
		{
			name:       "series episode-only token uses season folder",
			path:       "/tv/Power Rangers (1993)/Season 30/Episode 01 Powers from the Past.mkv",
			wantTitle:  "Power Rangers",
			wantYear:   1993,
			wantType:   "series",
			wantSeason: 30,
		...
		{
			name:       "SxxEyy takes precedence over NxNN when both appear",
			path:       "/tv/Show Name/Season 01/Show.Name.S01E03.7x13.mkv",
			wantTitle:  "Show Name",
			wantYear:   0,
			wantType:   "series",
			wantSeason: 1,
		...
		{
			name:       "movie episode word does not force series",
			path:       "/movies/The Episode (2024)/The Episode (2024).mkv",
			wantTitle:  "The Episode",
			wantYear:   2024,
			wantType:   "movie",
			wantSeason: 0,
			wantEp:     0,
...
func TestResolvePathContext(t *testing.T) {
	tests := []struct {
		...
		{
			name:                    "mixed flat tv folder NxNN stays series",
			path:                    "/mixed/Power Rangers/Power Rangers - 7x13 - Orion Returns.mkv",
			libraryType:             "mixed",
			wantType:                "series",
			wantRoot:                "/mixed/Power Rangers",
			wantTitle:               "Power Rangers",
			wantSeason:              7,
			wantEpisode:             13,
			wantEpisodePattern:      true,
		...
		{
			name:                    "mixed season folder episode-only token stays series",
			path:                    "/mixed/Power Rangers/Season 30/Episode 01 Powers from the Past.mkv",
			libraryType:             "mixed",
			wantType:                "series",
			wantRoot:                "/mixed/Power Rangers",
			wantTitle:               "Power Rangers",
