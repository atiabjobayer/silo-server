...
export const SETTING_DEFINITIONS: Record<SettingKey, SettingDefinition> = {
  "catalog.metadata_language": {
    ...
    description: "Fallback language Penguin prefers for titles, descriptions, and artwork.",
    category: "catalog",
    control: "select",
  ...
  "playback.audio_language": {
    ...
    description: "Choose which spoken language Penguin should prefer first.",
    category: "playback",
    control: "select",
  ...
  "playback.intro_skip_mode": {
    ...
    label: "Skip intros",
    description:
      "What Penguin does when an intro starts: leave it alone, offer a Skip Intro button, or skip it and offer an undo.",
    category: "playback",
    control: "select",
    values: [
  ...
  "playback.max_bitrate_kbps": {
    ...
    description:
      "Cap how much bandwidth playback may use. No cap means Penguin picks for the chosen resolution.",
    category: "playback",
    control: "select",
    unit: "kbps",
    minimum: 100,
  ...
  "playback.preferred_quality": {
    ...
    description: "Pick the quality Penguin should prefer.",
    category: "playback",
    control: "select",
    values: [
  ...
  "playback.subtitle_language": {
    ...
    description: "Choose which subtitle language Penguin should prefer first.",
    category: "playback",
    control: "select",
  ...
  "playback.subtitle_mode": {
    ...
    defaultValue: "auto",
    label: "Subtitles",
    description: "When Penguin should turn subtitles on.",
    category: "playback",
    control: "select",
    values: [
      { value: "auto", label: "Auto", introducedIn: 1 },
  ...
  "player.passout_threshold": {
    ...
    description:
      "How many episodes auto-play before Penguin asks whether you are still watching. 0 never asks.",
    category: "player",
    control: "stepper",
    unit: "episodes",
  ...
  "subtitle.matches_device": {
    ...
    description: "Use the operating system's caption style instead of Penguin's.",
    category: "playback",
    control: "switch",
    platforms: ["ios", "tvos", "macos", "android", "android_tv"],
  },
  ...
  "ui.theme": {
    ...
    label: "Theme",
    description: "Colour theme for the Penguin interface.",
    category: "appearance",
    control: "select",
    platforms: ["web"],
    values: [
