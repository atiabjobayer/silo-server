...
function RegisterRelayRow({
  ...
  const renewalStatus = expirationValid
    ? expiration.getTime() <= Date.now()
      ? "Expired; Penguin renews it before the next delivery."
      : `Expires ${expiration.toLocaleString()}; Penguin renews automatically.`
    : configured
      ? "Expiration unknown; Penguin refreshes the credential on its next renewal."
        ...
        >
          ...
          <ol className="list-decimal space-y-1.5 pl-4">
            ...
            <li>
              ...
              Intents (Presence, Server Members, Message Content) <strong>off</strong> — Penguin
  ...
  return (
    <div className="space-y-2 py-3">
      ...
      <div className="text-muted-foreground space-y-2 text-xs leading-relaxed">
        <p>
          If you enable push notifications, your Penguin Server sends a content-free request to
          Penguin's push relay so Penguin can deliver notifications through Apple Push Notification
        ...
        <p>
          ...
          request status, app topic, the IP address your self-hosted Penguin Server uses to contact
          ...
          >
            ...
            <div className="settings-field-list">
              <SettingField
                ...
                description="Covers every email Penguin sends, not just notifications."
                type="toggle"
          ...
          >
            <div className="settings-field-list">
              ...
              <SettingField
                ...
                description="Unlinked accounts show their Penguin username instead."
                type="toggle"
          ...
          <div className="space-y-3">
            ...
            <FieldGroup label="Retention" restartAll={allRestart(RETENTION_KEYS)}>
              ...
              >
                ...
                <SettingField
                  label="Sent history"
                  description="Record of what Penguin already notified about."
                  unit="days"
                  type="number"
