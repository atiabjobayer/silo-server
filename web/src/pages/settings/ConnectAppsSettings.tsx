    ...
    >
      ...
      <div className="min-w-0 space-y-0.5">
        <p className="text-sm font-medium">
          {isJellyfin ? "For Jellyfin-compatible apps only" : "For Penguin's own apps"}
        </p>
        <p className="text-muted-foreground text-xs leading-relaxed">
          {isJellyfin ? JELLYFIN_APP_EXAMPLES : SILO_APP_EXAMPLES}.{" "}
          {isJellyfin
            ? "These credentials will not work on a Penguin sign-in screen."
...
function TroubleshootingPanel({
  ...
  const rows = [
    ...
    },
    {
      ...
      a: "Type it in full and append #PIN anyway. Penguin splits at the last # only.",
    },
    {
    ...
    ...(compatURL
      ? [
          {
            q: "You used the Penguin app's address",
  ...
  return (
    <div className="space-y-6">
      ...
      >
        {(
          [
            { id: "silo", label: "Penguin app or website", icon: MonitorSmartphone },
      ...
      >
        ...
        {isLoading ? (
          ...
          <div className="border-border rounded-md border border-dashed px-3.5 py-4">
            ...
            <p className="text-muted-foreground mt-1 text-sm leading-relaxed">
              It signs in through an external provider rather than a Penguin password, and the
              compatibility API only accepts Penguin passwords. Use a Penguin app, or ask an administrator
            ...
            {isJellyfin ? (
              <p className="text-muted-foreground flex items-start gap-1.5 text-xs leading-relaxed">
                ...
                <span>
                  ...
                  name and PIN are appended here. This format is rejected on a Penguin sign-in screen.
                </span>
              </p>
            ) : (
